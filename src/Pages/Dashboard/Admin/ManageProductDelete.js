...
const ManageProductDelete = ({deleteProduct,setDeleteProduct,refetch}) => {
    const handleDelete = ()=>{
        axiosPrivate.delete(`all-products/${deleteProduct?._id}`)
        .then(response => {
      ...
      <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
          ...
          <div class="modal-action">
            <label onClick={handleDelete} className=" rounded-md uppercase px-4 flex items-center bg-red-600 text-white" for="product-delete" class="btn">
              Delete
            </label>
